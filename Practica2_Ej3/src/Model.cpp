...
/*Recibe un shader y recorre todo el arreglo de meshes para renderizarlo, o aplicarles texturas*/
void Model::render(Shader * shader) {
	for (GLuint i = 0; i < this->meshes.size(); i++)
		this->meshes[i].render(shader);
}

/*Recibe un path o ruta y mediante assimp carga el modelo que se va a mostrar en pantalla*/
...
/*Procesa cada mesh encontrado en processNode, calcula sus vertices, normales y coordenadas de texturas, y los manda
a la clase Mesh para renderizar*/
