...
void GLApplication::applicationLoop() {
	...
	//Posicion de modelos
	glm::vec3 pos_play;
	glm::vec3 pos_npc1(-55.0f, 0.0f, -25.0f);//cocodrilo
	glm::vec3 pos_npc2(60.0f, 0.0f, -40.0f);//trex
	glm::vec3 pos_npc3(50.0f, 0.0f, -30.0f);//pumpkin
	glm::vec3 pos_npc4(50.0f, 20.0f, -45.0f);//baymax
	...
	*/
	...
	Model objModel_P4("models/BaymaxWhiteOBJ/Bigmax_White_OBJ.obj");
	Model objModel_P3("models/HalloweenPumpkin_OBJ/Halloween_Pumpkin.obj");
	Model objModel_P2("models/trex/Trex.obj");
	Model objModel_P1("models/Cocodrilo/Cocodrilo.obj");
	Model objModel_Player("models/robot/Robot.obj");
	...
	while (processInput) {
		...
		/*Dibujo Terreno*/
		model = glm::scale(glm::mat4(), glm::vec3(50.0, 50.0, 50.0));
		...
		if (windowManager->inputManager.isGenerateRay()) {
			...
			if (raySphereIntersect(o, t, dir, c1, s1.ratio/*sbb1.ratio*/, t1)){
				if (angplay == 0.0f){
					angplay = 180.0f;
				}
				else{
			...
			if (raySphereIntersect(o, t, dir, c2, s2.ratio, t1)){
				if (angnpc3 == 0.0f){
					angnpc3 = 180.0f;
				}
				else{
